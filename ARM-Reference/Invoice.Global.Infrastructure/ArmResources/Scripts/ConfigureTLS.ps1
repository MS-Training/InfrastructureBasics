...
#   -EnableOlderTlsVersions :   $true/$false, default($true), use $false to explicitly disable TLS1.0, TLS1.1
#***************************************************************************************************************
...
Write-Log -Message "Enabling SchUseStrongCrypto, SystemDefaultTlsVersions"  -Logfile $logLocation -Severity Information
...
Write-Host "The keys SchUseStrongCrypto & SystemDefaultTlsVersions have been set."
Write-Log -Message "The keys SchUseStrongCrypto & SystemDefaultTlsVersions have been set. "  -Logfile $logLocation -Severity Information
